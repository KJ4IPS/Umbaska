...
public class Effects {
    ...
    public static void runRegister(){
        ...
        if (pl != null) {
            ...
            registerNewEffect(EffDenyPlayer.class, "deny %offline player% from %string% in %world%" );
            registerNewEffect(EffUnDeny.class,"allow %offline player% to %string% in %world%" );
        }
